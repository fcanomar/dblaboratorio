...
'data' : ['security/dblabo_security.xml','security/ir.model.access.csv','dblaboratorio_view.xml','laboratorio_view.xml','sequences.xml','caducidad_scheduler.xml','categories_data.xml'],
'demo': [],
'installable' : True,
'auto_install' : False,
}
